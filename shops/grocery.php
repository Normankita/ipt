...
<body>
    ...
    <div class="sidebar"  style="margin-top: 63px;">
        <a href="#home"><i class="fa fa-fw fa-home"></i>Fruits & Vegetables</a>
        <a href="#services"><i class="fa fa-fw fa-wrench"></i>Meat & Fist</a>
        <a href="#clients"><i class="fa fa-fw fa-user"></i> Dairy</a>
        <a href="#contact"><i class="fa fa-fw fa-envelope"></i> Beverage</a>
        <a href="#contact"><i class="fa fa-fw fa-envelope"></i> Cooking</a>
        <a href="#contact"><i class="fa fa-fw fa-envelope"></i> Breakfast</a>
    </div>
