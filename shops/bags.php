...
<body>
    ...
    <div class="sidebar"  style="margin-top: 63px;">
        <a href="#home"><i class="fa fa-fw fa-home"></i>Hand bags</a>
        <a href="#services"><i class="fa fa-fw fa-wrench"></i>Purse</a>
        <a href="#clients"><i class="fa fa-fw fa-user"></i> Shoulder bags</a>
