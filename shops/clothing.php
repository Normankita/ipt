...
<body>
    ...
    <div class="sidebar"  style="margin-top: 63px;">
        <a href="#home"><i class="fa fa-fw fa-home"></i>Women Dress</a>
        <a href="#services"><i class="fa fa-fw fa-wrench"></i>Outer Wear</a>
        <a href="#clients"><i class="fa fa-fw fa-user"></i> Pants</a>
        <a href="#contact"><i class="fa fa-fw fa-envelope"></i> Tops</a>
        <a href="#contact"><i class="fa fa-fw fa-envelope"></i> Skirts</a>
        <a href="#contact"><i class="fa fa-fw fa-envelope"></i> Shirts</a>
    </div>
